...
EXECOBJA=captcha.o lsd.o cgan.o super.o art.o tag.o cifar.o go.o instance-segmenter.o rnn.o segmenter.o regressor.o classifier.o coco.o yolo.o detector.o nightmare.o attention.o darknet_env.o darknet.o
ifeq ($(GPU), 1) 
LDFLAGS+= -lstdc++
